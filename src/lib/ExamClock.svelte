...
<div class="rounded-lg shadow-xl p-8 mb-6 transition-all duration-500 ease-out transform hover:shadow-2xl {highContrastMode ? 'bg-white border-4 border-yellow-400' : 'bg-white'}">
	<div class="text-center">
		<!-- Active Checkpoint Banner -->
		<CheckpointBanner checkpoint={activeCheckpoint} {highContrastMode} />
		
		<div 
			class="rounded-xl p-8 mb-4 transition-all duration-700 ease-out {highContrastMode ? 'bg-black' : 'bg-gradient-to-r from-indigo-50 to-blue-50'}" 
		...
		>
			...
			<!-- Date Display -->
			<div 
				class="text-lg md:text-xl xl:text-2xl mb-3 font-medium transition-all duration-300 ease-out {highContrastMode ? 'text-white font-bold' : 'text-gray-700'}"
			...
			{#if timezone}
				<div 
					class="text-base transition-all duration-300 ease-out {highContrastMode ? 'text-gray-300 font-bold' : 'text-gray-600'}"
			...
			{#if nextCheckpoint}
				<div 
					class="mt-4 p-3 rounded-lg transition-all duration-400 ease-out transform hover:scale-102 {highContrastMode ? 'bg-yellow-400 border-2 border-white' : 'bg-white bg-opacity-70'}"
		...
		<div class="flex items-center justify-center space-x-4 text-sm transition-all duration-300 ease-out {highContrastMode ? 'text-white' : 'text-gray-500'}">
			...
			<button 
				...
				class="px-3 py-1 rounded-lg transition-all duration-200 ease-out text-sm font-medium border transform hover:scale-105 active:scale-95 {highContrastMode ? 'bg-yellow-400 hover:bg-yellow-300 text-black border-2 border-white hover:shadow-lg' : 'bg-gray-100 hover:bg-gray-200 text-gray-700 hover:shadow-md'}"
